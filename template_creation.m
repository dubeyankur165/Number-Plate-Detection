...
%{
 Here, in the code below we are saving the images into a variable by using
 command ‘imread()’.
 This function is used to call the images from the folder or from
 any location of the PC into the MATLAB.
%}
